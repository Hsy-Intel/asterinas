...
impl<T: PageTableEntryTrait, M> PageTable<T, M> {
    ...
    /// page table. Note that the operations performed on this page table instance should be add mappings
    /// rather than modify the original mappings.
